                        ...
                        <!-- <header class="sticky top-0 z-50 bg-primary border-b border-accent/20">
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                <div class="flex items-center justify-between h-16 lg:h-20">
                                    <a class="flex items-center space-x-2" href="index.html" data-discover="true">
                                        <img src="images/logo.png" alt="" class="w-auto h-6" />
                                    </a>
                                    ...
                                    <div>
                                        ...
                                        <div class="max-w-xl mx-auto">
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <div class="w-2 h-2 bg-accent rounded-full"></div><span>Unsubscribe
                                                        anytime</span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                                ...
                                <div class="pt-8 border-t border-accent/20">
                                    <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-4">
                                        ...
                                        <div class="flex items-center gap-4"><a href="#" aria-label="Instagram"
                                                ...
                                                </svg></a><a href="#" aria-label="Facebook"
                                                class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-accent transition-colors"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                </svg></a><a href="#" aria-label="LinkedIn"
                                                class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-accent transition-colors"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <div
                                        class="flex flex-wrap justify-center gap-4 text-sm text-white/60 pt-4 border-t border-accent/10">
                                        <a class="hover:text-accent transition-colors" href=""
                                            data-discover="true">Terms of Service</a><span
                                            class="text-white/40">•</span><a class="hover:text-accent transition-colors"
                                            href="" data-discover="true">Privacy Policy</a><span
                                            class="text-white/40">•</span><a class="hover:text-accent transition-colors"
                                            href="" data-discover="true">Cookie Policy</a><span
                                            class="text-white/40">•</span><a class="hover:text-accent transition-colors"
                                            href="" data-discover="true">Returns &amp; Refunds</a><span
                                            class="text-white/40">•</span><a class="hover:text-accent transition-colors"
                                            href="" data-discover="true">Shipping Policy</a>
                                    </div>
                                </div>
                            </div>
                        </footer> -->
                        <?php get_footer() ?>
                        <button id="pageScroll"
                            class="fixed bottom-8 right-8 z-40 w-12 h-12 bg-gradient-to-br from-accent to-[#C8915D] text-white rounded-full shadow-[0_8px_24px_rgba(226,164,95,0.4)] hover:shadow-[0_12px_32px_rgba(226,164,95,0.6)] hover:scale-110 transition-all duration-300 flex items-center justify-center group"
                            tabindex="0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-arrow-up w-5 h-5 group-hover:-translate-y-0.5 transition-transform"
                                aria-hidden="true">
                                <path d="m5 12 7-7 7 7"></path>
                                <path d="M12 19V5"></path>
                            </svg>
                        </button>
                        <div id="resentDown" class="fixed left-4 bottom-24 z-30 max-w-sm">
                            <div class="bg-white rounded-2xl shadow-2xl border border-accent/20 p-4 backdrop-blur-lg">
                                <div class="flex items-start gap-3">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-accent to-[#C8915D] rounded-full flex items-center justify-center shrink-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                                            class="lucide lucide-shopping-bag w-5 h-5 text-white" aria-hidden="true">
                                            <path d="M16 10a4 4 0 0 1-8 0"></path>
                                            <path d="M3.103 6.034h17.794"></path>
                                            <path
                                                d="M3.4 5.467a2 2 0 0 0-.4 1.2V20a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6.667a2 2 0 0 0-.4-1.2l-2-2.667A2 2 0 0 0 17 2H7a2 2 0 0 0-1.6.8z">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-2 mb-1">
                                            <h4 class="font-semibold text-primary text-sm">Rahul V.</h4>
                                            <div class="w-1 h-1 bg-accent rounded-full"></div><span
                                                class="text-xs text-muted-foreground flex items-center gap-1"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    class="lucide lucide-map-pin w-3 h-3" aria-hidden="true">
                                                    <path
                                                        d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0">
                                                    </path>
                                                    <circle cx="12" cy="10" r="3"></circle>
                                        ...
                                        <p class="text-sm text-muted-foreground">downloaded the app</p>
                                        <p class="text-xs text-muted-foreground mt-1">12 min ago</p>
                                    </div>
                                    <div
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                                            class="lucide lucide-check w-3 h-3 text-accent" aria-hidden="true">
                                            <path d="M20 6 9 17l-5-5"></path>
                                        </svg>
                                    </div>
                                </div>
                                <div class="mt-3 h-1 bg-accent/20 rounded-full overflow-hidden">
                                    <div id="gradBox" class="h-full bg-gradient-to-r from-accent to-[#C8915D]"></div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#desktopIcon").click(function () {
                ...
                // Smooth dropdown
                $("#mobileNav")
                    .hide()          // ensures starting point
                    .removeClass("hidden")
                    .slideDown(300); // smooth open
            });
            ...
            $('#pageScroll').on("click", function () {
                $("html, body").animate({ scrollTop: 0 }, 500); // 500ms = smooth
            });
            $(window).on("scroll", function () {
                if ($(this).scrollTop() > 300) {
                    $("#pageScroll").fadeIn(300);   // show smoothly
                } else {
                    $("#pageScroll").fadeOut(300);  // hide smoothly
                }
            });
        });

        $(document).ready(function () {
            $("#resentDown").hide(); // start hidden

            function cycle() {
                // Wait 10s hidden, then show
                setTimeout(function () {

                    // SHOW resentDown
                    $("#resentDown").fadeIn(400);

                    // RESET gradBox width to 100% before animation
                    $("#gradBox").stop(true, true).css("width", "100%");

                    // START shrinking 100% → 0%
                    $("#gradBox").animate(
                        { width: "0%" },
                        5000,       // 5 seconds
                        "linear"
                    ...
                    }, 5000); // resentDown stays visible 5 seconds

                }, 5000); // FIRST SHOW after 5s, customize if needed
            }
